...
exports.getServerTypeSocketOffKey = exports.startServer = exports.defaultConfiguration = void 0;
...
;
function getServerTypeSocketOffKey(t1, t2) {
    if (t1 <= t2) {
        return t1 + "_" + t2;
    }
    else {
...
exports.getServerTypeSocketOffKey = getServerTypeSocketOffKey;
