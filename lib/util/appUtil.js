...
var loadBaseConfig = function (app) {
    loadConfigBaseApp(app, "masterConfig", path.join(define_1.default.File_Dir.Config, 'master.js'));
    loadConfigBaseApp(app, "rpcServersConfig", path.join(define_1.default.File_Dir.Config, 'rpc.js'));
    loadConfigBaseApp(app, "serversConfig", path.join(define_1.default.File_Dir.Config, 'servers.js'));
    loadConfigBaseApp(app, "routeConfig", path.join(define_1.default.File_Dir.Config, 'route.js'));
