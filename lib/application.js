...
var Application = /** @class */ (function (_super) {
    ...
    function Application() {
        ...
        _this.routeConfig = []; // route.json
        _this.masterConfig = {}; // master.json
        _this.rpcServersConfig = []; // rpc.json
        _this.serversConfig = {}; // servers.json
        ...
        _this.serverToken = define_1.default.Server_Token; // 服务器内部认证密钥
        _this.clientToken = define_1.default.Master_Client_Token; // master与cli的认证密匙
        ...
        _this.rpc = {}; // rpc包装
        _this.rpcService = RpcService; // 用户服务器，rpc调用管理
        _this.remoteBackend = RemoteBackend; // 后端服务器，用来管理前端连接
        _this.remoteFrontend = RemoteFrontend; // 前端服务器，用来管理连接后端
