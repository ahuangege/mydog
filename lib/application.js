...
var Application = /** @class */ (function (_super) {
    ...
    function Application() {
        ...
        _this.cliToken = define_1.some_config.Cli_Token; // master与cli的认证密匙
        ...
        _this.connectorConfig = {}; // 前端connector配置
        _this.rpcConfig = {}; // rpc配置
        _this.frontendServer = new frontendServer_1.FrontendServer(_this);
        _this.backendServer = new backendServer_1.BackendServer(_this);
     ...
     * @param config
     */
    Application.prototype.setEncodeDecodeConfig = function (config) {
     ...
     * @param config
     */
    Application.prototype.setConnectorConfig = function (config) {
     ...
     * @param config
     */
    Application.prototype.setRpcConfig = function (config) {
