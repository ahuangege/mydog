...
var Session = /** @class */ (function () {
    ...
    Session.prototype.resetBuf = function () {
        if (app.frontend) {
            var tmpBuf = Buffer.from(JSON.stringify({ "uid": this.uid, "sid": this.sid, "settings": this.settings }));
    ...
    Session.prototype.set = function (_settings) {
    ...
    Session.prototype.delete = function (keys) {
