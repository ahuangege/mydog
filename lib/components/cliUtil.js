...
var MasterCli = /** @class */ (function () {
    ...
    MasterCli.prototype.func_list = function (reqId, socket, args) {
        ...
        var listFunc = this.app.someconfig.mydogList;
    ...
    MasterCli.prototype.func_removeT = function (reqId, socket, args) {
        var num = 0;
        for (var x in this.servers) {
            var one = this.servers[x];
...
var MonitorCli = /** @class */ (function () {
    ...
    MonitorCli.prototype.func_removeT = function (reqId, socket, args) {
        var msg = {
            "T": 3 /* cliMsg */,
            "reqId": reqId,
        };
