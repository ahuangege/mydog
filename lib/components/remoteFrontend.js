...
function doRemote(msgBuf, session, serverType) {
    ...
    tmpRouter(app, session, serverType, function (err, sid) {
        if (err) {
            app.logger(interfaceDefine_1.loggerType.debug, interfaceDefine_1.componentName.remoteFrontend, err);
            return;
        }
        ...
        buf.writeUInt8(define_1.default.Front_To_Back.msg, 4);
...
var remote_frontend_client = /** @class */ (function () {
    ...
    remote_frontend_client.prototype.doConnect = function (delay) {
        ...
        this.connect_timer = setTimeout(function () {
            self.socket = new tcpClient_1.TcpClient(self.port, self.host, function () {
                ...
                buf.writeUInt8(define_1.default.Front_To_Back.register, 4);
                loginBuf.copy(buf, 5);
            ...
            self.socket.on("close", function () {
                ...
                self.doConnect(define_1.default.Time.Remote_Reconnect_Time * 1000);
            });
        }, delay);
    };
    /**
    ...
    remote_frontend_client.prototype.heartbeat = function () {
        ...
        this.heartbeat_timer = setTimeout(function () {
            ...
            buf.writeUInt8(define_1.default.Front_To_Back.heartbeat, 4);
            self.socket.send(buf);
            self.heartbeat();
        }, define_1.default.Time.Remote_Heart_Beat_Time * 1000);
    };
    /**
     * 消息分类
     */
    remote_frontend_client.prototype.data_switch = function (msg) {
        ...
        if (type === define_1.default.Back_To_Front.msg) {
            this.msg_handle(msg);
        }
        else if (type === define_1.default.Back_To_Front.applySession) {
